...
* http://maplacejs.com
*/
(function(f,s,d,undefined){'use strict';var q,n,p;q={activateCurrent:function(c){this.html_element.find("select").val(c)},getHtml:function(){var c=this,a="",b;if(1<this.ln){a+='<select id="dropdownMaplace" class="dropdown controls '+this.o.controls_cssclass+'">';this.ShowOnMenu(this.view_all_key)&&(a+='<option value="'+this.view_all_key+'" id="viewAll">'+this.o.view_all_text+"</option>");for(b=0;b<this.ln;b+=1)this.ShowOnMenu(b)&&(a+='<option value="'+(b+1)+'">'+(this.o.locations[b].title||"#"+(b+1))+"</option>");a=f(a+"</select>").bind("change",function(){c.ViewOnMap(this.value)})}(b=
